...
class SubsidyGoodsRequest extends JttRequest
{
    ...
    //page 	Int 	否 	分页获取数据（默认第1页）
    public $page = 1;
    //num 	String 	否 	单页面显示条数(最大100条最少10条)
    public $num = 10;
    //goods_new_type 	Int 	否 	京推推商品一级类目： 0全部；1居家日用；2食品；3生鲜；4图书；5美妆个护；6母婴；7数码家电；8内衣；9配饰；10女装；11男装；12鞋品；13家装家纺；14文娱车品；15箱包；16户外运动（支持多类目筛选，如1,2获取类目为女装、男装的商品，逗号仅限英文逗号）
    public $goodsNewType;
